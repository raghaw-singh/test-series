    ...
    <div class="col-md-12">
        <div class="nav-tabs-custom">
            <div class="box-header with-border">
                <h3 class="box-title titlefix"><?= get_phrase('manage_SMS_template');?></h3>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if(has_permission(EDIT, 'administrator', 'smstemplate')){ ?>
                                            <a href="<?php echo site_url('administrator/smstemplate/edit/'.$obj->id); ?>" class="btn btn-success btn-xs"><i class="fa fa-edit"></i> <?php echo get_phrase('edit'); ?> </a>
                                        <?php } ?>
                                        <?php if(has_permission(DELETE, 'administrator', 'smstemplate')){ ?>
                                            <a href="<?php echo site_url('administrator/smstemplate/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo get_phrase('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo get_phrase('delete'); ?> </a>
                                        <?php } ?>
                                    </td>
                                </tr>
                                <?php } ?>
                ...
                <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_template">
                    <?php echo form_open_multipart(site_url('administrator/smstemplate/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea  class="form-control" name="template" id="add_template" required="required" placeholder="<?php echo get_phrase('template'); ?>" rows="10"> </textarea>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-3">
                                <a href="<?php echo site_url('administrator/smstemplate/index'); ?>" class="btn btn-primary"><?php echo get_phrase('cancel'); ?></a>
                ...
                <div  class="tab-pane fade in <?php if(isset($edit)){ echo 'active'; }?>" id="tab_edit_template">
                    <?php echo form_open_multipart(site_url('administrator/smstemplate/edit'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="template"><?php echo get_phrase('template'); ?> <span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea  class="form-control" name="template" id="edit_template" required="required" placeholder="<?php echo get_phrase('template'); ?>" rows="10"><?php if(isset($template)){ echo $template->template;} ?> </textarea>
                                <div class="help-block"><?php echo form_error('template'); ?></div>
                            </div>
                        </div>                      
                        <div class="form-group">
