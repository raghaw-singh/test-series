...
class Language extends MY_Controller {
    ...
    * ********************************************************** */
    public function index() {
        ...
        $this->data['list'] = TRUE;
        $this->layout->title(get_phrase('manage_language'). ' | ' . SMS);
    ...
    * ********************************************************** */
    public function add() {
        ...
        $this->data['list'] = TRUE;
        $this->layout->title(get_phrase('add'). ' ' . get_phrase('languge'). ' | ' . SMS);
        $this->layout->view('index', $this->data);
    }
    ...
    * ********************************************************** */
    public function edit($language = null) {
        ...
        $this->layout->title(get_phrase('edit'). ' ' . get_phrase('language'). ' | ' . SMS);
        $this->layout->view('index', $this->data);
    }
    ...
    * ********************************************************** */
    private function _prepare_language_validation() {
        ...
        $this->form_validation->set_rules('name', get_phrase('language').' '.get_phrase('name'), 'trim|required');
    }
    ...
    * ********************************************************** */
    public function label($language = null) {
        ...
        if (!$language) {
            ...
            $this->layout->title(get_phrase('edit'). ' ' . get_phrase('label'). ' | ' . SMS);
            $this->layout->view('index', $this->data);
        }
    }
