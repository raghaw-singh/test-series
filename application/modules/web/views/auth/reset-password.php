                    ...
                    <div class="col-lg-6 col-md-8">
                        <div class="sign_form">
                            <form method="post" onsubmit="return false" autocomplete="off" id="user_forgot_form">
                                <input type="hidden" name="reset_key" value="<?= $getData->reset_key;?>">
                                ...
                                <div class="ui search focus mt-15">
                                    <div class="ui left icon input swdh95">
                                        <input class="prompt srch_explore" type="password" name="confirm_password" id="confirm_password" maxlength="64" placeholder="Confirm Password" />
                                        <i class="uil uil-key-skeleton-alt icon icon2"></i>
                                    </div>
                                </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                $(document).on('click', '.login-btn', function (e) {
                    ...
                    $.ajax({
                        url: "<?= base_url('web/auth/resetPassword');?>",
                        type: 'post',
