                    ...
                    <div class="col-lg-6 col-md-8">
                        <div class="sign_form">
                            <?php if(get_settings('fb_social_login')){
                                $this->load->view('auth/facebook_login');
                            } ?>
                            <?php $this->load->view('auth/gmail_login');?>
                            
                            <form method="post" onsubmit="return false" autocomplete="off" id="user_login_form">
                                ...
                                <div class="ui search focus mt-15">
                                    <div class="ui left icon input swdh95">
                                        <input class="prompt srch_explore" type="password" name="password" id="id_password" maxlength="64" placeholder="Password" />
                            ...
                            <p class="sgntrm145">Or <a href="<?= base_url('auth/v1/forgot-password');?>">Forgot Password</a>.</p>
                            <p class="mb-0 mt-30 hvsng145">Don't have an account? <a href="<?= base_url('auth/v1/register');?>">Sign Up</a></p>
                        </div>
