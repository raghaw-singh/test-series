    ...
    <div class="col-md-12">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a ><i class="fa fa-plus-square-o"></i> <?= get_phrase('add_section') ?></a>
                </li>
            </ul>
                        ...
                        <form method="post" id="student_form" autocomplete="off" class="form-horizontal form-label-left" onsubmit="return false" accept-charset="utf-8">
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" name="section" type="text" />
...
<script type="text/javascript">
    ...
    $('#student_form').on('submit',function(){
        $this = $(this);
        $.ajax({
            url: base_url+"academic/section/save_add",
            type:"post",
