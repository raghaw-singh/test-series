    ...
    <div class="col-md-12">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a ><i class="fa fa-plus-square-o"></i> <?= get_phrase('add_class') ?></a>
                </li>
            </ul>
            <div class="tab-content">
                <div>
                    <div class="x_content">
                        <form method="post" id="update_form" autocomplete="off" class="form-horizontal form-label-left" onsubmit="return false" accept-charset="utf-8">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" name="class" type="text" value="<?= $classData->class ?>" />
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select name="teacher_name" class="form-control col-md-7 col-xs-12">
                                        ...
                                        <option value="<?= $obj->user_id;?>" <?php if($classData->teacher_name==$obj->user_id) echo 'selected'; ?>> <?= $obj->name ?></option>
                                        <?php } ?>
                                    </select>    
                                    <div class="help-block"></div>
                                </div>
...
<script type="text/javascript">
    ...
    $('#update_form').on('submit',function(){
        $this = $(this);
        $.ajax({
            url: base_url+"academic/student_class/save_edit",
            type:"post",
