    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title titlefix"><?= get_phrase('edit').' '.get_phrase('question_group');?></h3>
                ...
                <form method="post" class="form-horizontal" onsubmit="return false" id="form" autocomplete="off">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control col-md-7 col-xs-12" name="title" type="text" value="<?= $group_info->title; ?>" />
...
<script type="text/javascript">
    ...
    $('#form').on('submit',function(){
        $this = $(this);
        $.ajax({
            url: base_url+"online_exam/question_group/save_edit",
            type:"post",
