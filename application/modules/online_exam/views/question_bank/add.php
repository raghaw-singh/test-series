        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <?php if(has_permission(VIEW,'online_exam','question_bank')){?>
                    <a href="<?= base_url('online_exam/question_bank/index');?>" class="btn btn-info"><?= get_phrase('question').' '.get_phrase('list');?></a>
                    <?php } ?>
                </div>
            </div>
            <div class="box-body">
            	<form method="post" class="form-horizontal" onsubmit="return false" id="add_question_form" autocomplete="off">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" id="question" name="main_question"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
					    <label for="photo" class="col-sm-3 control-label"> Upload </label>
					    <div class="col-sm-4">
					...
					<div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control col-md-7 col-xs-12" name="mark" type="text" />
...
<link rel="stylesheet" href="https://demo.itest.inilabs.xyz/assets/editor/jquery-te-1.4.0.css">
<script type="text/javascript" src="https://demo.itest.inilabs.xyz/assets/editor/jquery-te-1.4.0.min.js"></script>
...
function saveQuestion() {
    ...
    $.ajax({
        url: "<?= base_url('online_exam/question_bank/save_question_bank');?>",
        type: "post",
        data: data,
...
function formHtmlData(id, type, value = "", checked = "") {
    ...
    var html ='<div class="form-group coption  option_number"><label for="option' +id+'" class="col-sm-3 control-label">Option ' +id +'</label><div class="col-sm-4"  style="display:inline-table"><input type="text" class="form-control" id="option' +
