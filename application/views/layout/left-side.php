...
<aside class="main-sidebar" id="alert2">
    <section class="sidebar" id="sibe-box">
        <ul class="sidebar-menu verttop">
            ...
            <?php } ?>
            <?php if(has_permission(VIEW,'online_exam','online_exam') || has_permission(VIEW,'online_exam','question_bank')){?>
            <li class="treeview <?php if($segment1=='online_exam') echo 'active';?>">
                ...
                <ul class="treeview-menu">
                    <?php if(has_permission(VIEW,'online_exam','online_exam')){?>
            ...
            <?php } ?>
            <?php if(has_permission(VIEW,'academic','student_class') || has_permission(VIEW,'academic','section') || has_permission(VIEW,'academic','subject')){?>
            <li class="treeview <?php if($segment1=='academic') echo 'active';?>">
                ...
                <ul class="treeview-menu">
                    <?php if(has_permission(VIEW,'academic','student_class')){?>
                    <li class="<?php echo active_link('student_class'); ?>">
                    ...
                    <li class="<?php echo active_link('section'); ?>">
                    ...
                    <li class="<?php echo active_link('subject'); ?>">
