...
class MY_Model extends CI_Model {
    ...
    function get_single_by_asc($table_name, $index_array, $columns = null) {
    ...
    function get_all($table_name, $index_array, $columns = null) {
    ...
    function get_single_slug($table_name, $index_array, $columns = null) {
